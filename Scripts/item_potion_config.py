...
string_table_id = "/Game/Inventory/StringTables/ST_Potions.ST_Potions"
texture_folder_path = "/Game/Inventory/Textures/Potions" # Folder where T_AC_00 etc. live
...
with unreal.ScopedSlowTask(len(selected_assets), "Updating Data Assets") as slow_task:
    ...
    for asset in selected_assets:
        ...
        name_key = f"AB.{index_int}.Name"
        desc_key = f"AB.{index_int}.Desc"
